                ...
                <tbody>
                    <tr>
                        <td class="cart-image-wrapper">
                            <a href="#"><img class="cart-image" src="{{url('assets-frontend')}}/images/cart-img-1.jpg" alt=""></a>
                        </td>
                        <td class="product-tit"><a href="#">Lmao</a></td>
                        <td class="price"><span class="money">$2.00</span></td>
                        <td>
                            <div class="qty">
                    ...
                    <tr>
                        <td class="cart-image-wrapper"><a href="#"><img class="cart-image" src="{{url('assets-frontend')}}/images/cart-img-2.jpg"
                                    alt=""></a></td>
                        <td class="product-tit"><a href="#">Bru</a></td>
                        <td class="price"><span class="money">$3.00</span></td>
                        <td>
                            <div class="qty">
                ...
                <tfoot>
                    <tr>
                        <td colspan="6">
                            ...
                            <div class="r-part">
                                <a class="cancle-cart-btn" href="#"><i class="icon-cancel-music"></i>delete cart</a>
                                <a class="update-cart-btn" href="#"><i class="icon-refresh"></i>update cart</a>
                            </div>
                        </td>
                    </tr>
                </tfoot>
            ...
            <div class="col-md-5 col-sm-6 col-sm-12 pull-right  wow fadeInRight">
                <div class="total-box">
                    ...
                    <div class="total-box-inner">
                        <div class="sub-total"><span>Subtotal </span><span class="price">$10.00</span></div>
                        <div class="grand-total"><span>Grand Total </span><span class="price">$12.00</span></div>
                        <a class="checkout-btn" href="#"><i class="icon-check-mark"></i>Proceed to checkout</a>
                    </div>
                </div>
            </div>
