                    ...
                    <table>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td class="product-img">
                                    <a href="#">
                                        <img class="cart-image" src="{{url('assets-frontend')}}/images/deal-img-4.jpg" alt="">
                                    </a>
                                </td>
                            ...
                            <tr>
                                <td class="product-img">
                                    <a href="#">
                                        <img class="cart-image" src="{{url('assets-frontend')}}/images/deal-img-6.jpg" alt="">
                                    </a>
                                </td>
                                <td class="product-tit">
                                ...
                                <td class="price">
                                    <span class="money">$2.29 / bunch</span>
                                </td>
                                <td>
                                    <div class="amount">
                                        <select>
                        ...
                        <tfoot>
                            <tr>
                                <td colspan="6">
                                    <div class="l-part">
                                        <a class="shopping-btn" href="#">Continue with Shopping
                                            <i class="far fa-arrow-right"></i>
                                        </a>
                                    </div>
                                    <div class="r-part">
                                        <a class="clear-cart-btn" href="#">
                                            <i class="far fa-times"></i>clear cart
                                        </a>
                                        <a class="update-cart-btn" href="#">
                                            <i class="far fa-sync-alt"></i>update cart
                                        </a>
                                    </div>
                                </td>
                            </tr>
                    ...
                    <div class="shopping-tax">
                        <div class="tax-box">
                            ...
                            <div class="box-inner">
                                ...
                                <button class="write">
                                    <i class="fad fa-clipboard"></i>Get a Quote
                                </button>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="total-box">
                            ...
                            <div class="total-box-inner">
                                ...
                                <a class="checkout-btn" href="#">
                                    <i class="far fa-check"></i>Proceed to checkout
                                </a>
                            </div>
                        </div>
                    </div>
