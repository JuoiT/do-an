                        ...
                        <form action="{{route('blog.update', $blog->id)}}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="input-field col s12">
                                    <input type="text" id="title" value="{{ old('title')?old('title'):$blog->title }}" name="title" placeholder="Title">
                            ...
                            <div class="row">
                                <div class="input-field col s12">
                                    ...
                                    <p>
                                        <label>
                                            <input name="status" type="radio" value="1" {{((old('status')?old('status'):$blog->status))=='1'?'checked':''}} />
                                            <span>Available</span>
                                        </label>
                                    </p>
                                    <p>
                                        <label>
                                            <input name="status" type="radio" value="0" {{((old('status')?old('status'):$blog->status))=='0'?'checked':''}}/>
