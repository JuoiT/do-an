    ...
    <div class="container">
        <div class="row">
            <div class="top-footer">
                <div class="col-md-3 col-sm-12 col-xs-12">
                    ...
                    <div class="mail"><i class="icon-envelope"></i><a
                            href="mailto:kemkiuu@gmail.com">kemkiuu@gmail.com</a></div>
                </div>
                <div class="col-md-7 col-sm-12 col-xs-12">
                    ...
                    <div class="col-sm-4 col-xs-12">
                        ...
                        <ul class="widget">
                            <li><a href="{{route('my_account')}}">Your Account</a></li>
                ...
                <div class="col-md-2 col-sm-12 col-xs-12">
                    ...
                    <div class="insta-img-box">
                        <img class="img-responsive" src="{{url('assets-frontend')}}/images/instagram-img-1.jpg" />
                        <img class="img-responsive" src="{{url('assets-frontend')}}/images/instagram-img-2.jpg" />
                        <img class="img-responsive" src="{{url('assets-frontend')}}/images/instagram-img-3.jpg" />
                        <img class="img-responsive" src="{{url('assets-frontend')}}/images/instagram-img-4.jpg" />
                        <img class="img-responsive" src="{{url('assets-frontend')}}/images/instagram-img-5.jpg" />
                        <img class="img-responsive" src="{{url('assets-frontend')}}/images/instagram-img-6.jpg" />
                    </div>
                </div>
            </div>
            <div class="bottom-footer">
                ...
                <div class="rpart">
                    <ul class="payment">
                        <li><a href="#"><img class="img-responsive" src="{{url('assets-frontend')}}/images/card-1.png" /></a></li>
                        <li><a href="#"><img class="img-responsive" src="{{url('assets-frontend')}}/images/card-2.png" /></a></li>
                        <li><a href="#"><img class="img-responsive" src="{{url('assets-frontend')}}/images/card-3.png" /></a></li>
                        <li><a href="#"><img class="img-responsive" src="{{url('assets-frontend')}}/images/card-4.png" /></a></li>
                    </ul>
                </div>
            </div>
        </div>
