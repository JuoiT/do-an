        ...
        <div class="col s12 m6 l8">
            <div id="placeholder" class="card card card-default scrollspy">
                <div class="card-content">
                    <h4 class="card-title">Sửa thông tin phương thức thanh toán</h4>
                    <form action="{{route('payment.update', $payment->id)}}" method="POST">
                        ...
                        <div class="row">
                            <div class="input-field col s12">
                                <input type="text" id="name" value="{{$payment->name}}" name="name" placeholder="Name">
                        ...
                        <div class="row">
                            <div class="input-field col s12">
                                ...
                                <p>
                                    <label>
                                        <input name="status" type="radio" value="1" {{($payment->status == 1) ? 'checked' : ''}}/>
                                        <span>Còn</span>
                                    </label>
                                </p>
                                <p>
                                    <label>
                                        <input name="status" type="radio" value="0" {{($payment->status == 0) ? 'checked' : ''}}/>
                                        <span>Hết</span>
                                    </label>
                                </p>
                        ...
                        <div class="row">
                            <div class="input-field col s12">
                                <input type="text" value="{{$payment->description}}" name="description" placeholder="Description">
