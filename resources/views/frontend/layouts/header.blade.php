                ...
                <div class="icon-nav">
                    <div class="item-left">
                        <div class="item item-1"><a href="">
                                <a href="{{url('assets-frontend')}}/html/whishlist.html"><i class="fal fa-heart icon-item__small"></i><span class="amount">01</span></a>
                        </div>
                    </div>
                    <div class="item-right">
                        <div class="item item-2">
                            <a href="{{route('cart')}}"><i class="fal fa-search icon-item__small"></i></a>
                        </div>
                        <div class="item item-3">
                            <a href="{{url('assets-frontend')}}/html/shopping_cart.html"><i class="fal fa-shopping-bag icon-item__small"></i>
