...
class EditSlideRequest extends FormRequest
{
    ...
    public function messages()
    {
        return [
            ...
            'content.required' => "Content không được để rỗng!",
            'content.max' => "Content không được quá 20 ký tự!",
            'caption.required' => "Caption không được để rỗng!",
            'caption.max' => "Caption không được quá 20 ký tự!",
